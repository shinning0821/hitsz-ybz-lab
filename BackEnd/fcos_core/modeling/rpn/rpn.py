...
from fcos_core.modeling.rpn.ddtnet.ddtnet import build_ddtnet
from fcos_core.modeling.rpn.pncnet.pncnet import build_pncnet
...
def build_rpn(cfg, in_channels):
    ...
    #     return build_ddtnet(cfg, in_channels)
    if cfg.MODEL.DDTNET_ON:
        return build_pncnet(cfg, in_channels)
