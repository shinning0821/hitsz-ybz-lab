...
def make_fcos_postprocessor(config):
    ...
    pre_nms_thresh = config.MODEL.DDTNet.INFERENCE_TH
    pre_nms_top_n = config.MODEL.DDTNet.PRE_NMS_TOP_N
    nms_thresh = config.MODEL.DDTNet.NMS_TH
    ...
    box_selector = FCOSPostProcessor(
        ...
        min_size=0,
        num_classes=config.MODEL.DDTNet.NUM_CLASSES,
