...
_C.MODEL.DDTNET_ON = False
_C.MODEL.RETINANET_ON = False
_C.MODEL.KEYPOINT_ON = False
_C.MODEL.SSD_ON = False
...
_C.INPUT.MIN_SIZE_TRAIN = (320,)  # (800,)
# The range of the smallest side for multi-scale training
_C.INPUT.MIN_SIZE_RANGE_TRAIN = (320,)  # -1 means disabled and it will use MIN_SIZE_TRAIN
# Maximum size of the side of the image during training
_C.INPUT.MAX_SIZE_TRAIN = 320
# Size of the smallest side of the image during testing
_C.INPUT.MIN_SIZE_TEST = 320
# Maximum size of the side of the image during testing
_C.INPUT.MAX_SIZE_TEST = 320
...
_C.DATASETS.TEST = ()
# Name of dataset:"BCa", "Post" or "TCGA"
_C.DATASETS.NAME = "BCa"
...
_C.MODEL.BACKBONE.CONV1XK = False
...
_C.MODEL.RPN.ANCHOR_SIZES = (16, 26, 40, 55)
# Stride of the feature map that RPN is attached.
# For FPN, number of strides should match number of scales
_C.MODEL.RPN.ANCHOR_STRIDE = (8, 16, 32, 64)
# RPN anchor aspect ratios
_C.MODEL.RPN.ASPECT_RATIOS = (0.5, 1.0, 1.5, 2.0)
# Remove RPN anchors that go outside the image by RPN_STRADDLE_THRESH pixels
# Set to -1 or a large value, e.g. 200100, to disable pruning anchors
_C.MODEL.RPN.STRADDLE_THRESH = 0
# Minimum overlap required between an anchor and ground-truth box for the
# (anchor, gt box) pair to be a positive example (IoU >= FG_IOU_THRESHOLD
# ==> positive RPN example)
_C.MODEL.RPN.FG_IOU_THRESHOLD = 0.45
# Maximum overlap allowed between an anchor and ground-truth box for the
# (anchor, gt box) pair to be a negative examples (IoU < BG_IOU_THRESHOLD
# ==> negative RPN example)
_C.MODEL.RPN.BG_IOU_THRESHOLD = 0.4
# Total number of RPN examples per image
_C.MODEL.RPN.BATCH_SIZE_PER_IMAGE = 2001
# Target fraction of foreground (positive) examples per RPN minibatch
_C.MODEL.RPN.POSITIVE_FRACTION = 0.5
# Number of top scoring RPN proposals to keep before applying NMS
# When FPN is used, this is *per FPN level* (not total)
_C.MODEL.RPN.PRE_NMS_TOP_N_TRAIN = 12000
_C.MODEL.RPN.PRE_NMS_TOP_N_TEST = 2001
# Number of top scoring RPN proposals to keep after applying NMS
_C.MODEL.RPN.POST_NMS_TOP_N_TRAIN = 2000
_C.MODEL.RPN.POST_NMS_TOP_N_TEST = 2001
...
_C.MODEL.RPN.FPN_POST_NMS_TOP_N_TEST = 2001
...
_C.MODEL.ROI_HEADS.DETECTIONS_PER_IMG = 2001
...
_C.MODEL.RESNETS.BACKBONE_OUT_CHANNELS = 256 * 2
...
_C.MODEL.FCOS.INFERENCE_TH = 0.4
_C.MODEL.FCOS.NMS_TH = 0.5
_C.MODEL.FCOS.PRE_NMS_TOP_N = 2001
...
# ---------------------------------------------------------------------------- #
_C.MODEL.DDTNet = CN()
_C.MODEL.DDTNet.NUM_CLASSES = 2  # the number of classes including background
_C.MODEL.DDTNet.FPN_STRIDES = [4, 8, 16, 32, 64]
_C.MODEL.DDTNet.PRIOR_PROB = 0.01
_C.MODEL.DDTNet.INFERENCE_TH = 0.5
_C.MODEL.DDTNet.NMS_TH = 0.44
_C.MODEL.DDTNet.PRE_NMS_TOP_N = 3001

# Focal loss parameter: alpha
_C.MODEL.DDTNet.LOSS_ALPHA = 0.25
# Focal loss parameter: gamma
_C.MODEL.DDTNet.LOSS_GAMMA = 2.0

# the number of convolutions used in the cls and bbox tower
_C.MODEL.DDTNet.NUM_CONVS = 4

# IOU_LOSS_TYPE can be "original" or "manual dots"
_C.MODEL.DDTNet.CENTER_SAMPLING = "original"
# if CENTER_SAMPLING_RADIUS <= 0, it will disable center sampling
_C.MODEL.DDTNet.CENTER_SAMPLING_RADIUS = 0.0
# IOU_LOSS_TYPE can be "iou", "linear_iou" or "giou"
_C.MODEL.DDTNet.IOU_LOSS_TYPE = "iou"

_C.MODEL.DDTNet.NORM_REG_TARGETS = False
_C.MODEL.DDTNet.CENTERNESS_ON_REG = False

_C.MODEL.DDTNet.USE_DCN_IN_TOWER = False
...
_C.MODEL.RETINANET.ANCHOR_SIZES = (15, 24, 36, 48, 60)
_C.MODEL.RETINANET.ASPECT_RATIOS = (1.0, 1.5, 2.0)#(1.0, 1.5, 2.0)
_C.MODEL.RETINANET.ANCHOR_STRIDES = (8, 16, 32, 64, 128)
_C.MODEL.RETINANET.STRADDLE_THRESH = 0

# Anchor scales per octave--min/max area of anchor
...
_C.MODEL.RETINANET.BBOX_REG_WEIGHT = 2.0
...
# per FPN level
_C.MODEL.RETINANET.PRE_NMS_TOP_N = 2001
...
_C.MODEL.RETINANET.BG_IOU_THRESHOLD = 0.45

# Focal loss parameter: alpha 0.25
...
_C.MODEL.RETINANET.INFERENCE_TH = 0.45

# NMS threshold used in RetinaNet
_C.MODEL.RETINANET.NMS_TH = 0.3
...
# This is global, so if we have 8 GPUs and IMS_PER_BATCH = 16, each GPU will
# see 2 images per batch
_C.TEST.IMS_PER_BATCH = 6
# Number of detections per image
_C.TEST.DETECTIONS_PER_IMG = 2001
